#ifndef REGIONS_BITMAP_H
#define REGIONS_BITMAP_H

// #include "regions/ukraine.h"

#include "regions/vinnytsia.h"          //1
#include "regions/volyn.h"              //2
#include "regions/dnipropetrovsk.h"     //3
#include "regions/donetsk.h"            //4
#include "regions/zhytomyr.h"           //5
#include "regions/zakarpattia.h"        //6
#include "regions/zaporizhzhia.h"       //7
#include "regions/frankivsk.h"          //8
#include "regions/kyiv.h"               //9
#include "regions/kirovohrad.h"         //10
#include "regions/luhansk.h"            //11
#include "regions/lviv.h"               //12
#include "regions/mykolaiv.h"           //13
#include "regions/odesa.h"              //14
#include "regions/poltava.h"            //15
#include "regions/rivne.h"              //16
#include "regions/sumy.h"               //17
#include "regions/ternopil.h"           //18
#include "regions/kharkiv.h"            //19
#include "regions/kherson.h"            //20
#include "regions/khmelnytskyi.h"       //21
#include "regions/cherkasy.h"           //22
#include "regions/chernivtsi.h"         //23
#include "regions/chernihiv.h"          //24

#include "regions/crimea.h"             //0

Region *regions[] =    {&crimea,
                        &vinnytsia,
                        &volyn,
                        &dnipropetrovsk,
                        &donetsk,
